...
public class PropertySquareEntityTest {
    ...
    public void testExecute() {
        ...
        Square square = new PropertySquare(property);
        Player player1 = new HumanPlayer(new ArrayList<Property>(), false);
        Player player2 = new HumanPlayer(List.of(property), false);
        Game game = new Game(null, new User("test", "test", "test"));
//        game.setPlayersIterator(new PlayerIterator(List.of(player1)));
        try {
            square.execute(game,player1);
        } catch (Exception e) {
            fail("Exepcion");
        }
    }
